...
import { authOptions } from "@/libs/auth"; // Fixed from @/lib/auth
import prisma from "@/libs/prisma"; // Fixed from @/lib/prisma
import { Project } from "@/models/project"; // Fixed from @models/project (missing slash)
